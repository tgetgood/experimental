...
8:                                                ; preds = %0, %8
  %9 = phi i32 [ %12, %8 ], [ 0, %0 ]
  %10 = phi i8 [ %14, %8 ], [ %6, %0 ]
  %11 = getelementptr inbounds [15 x i8], [15 x i8]* %1, i32 0, i32 %9
...
18:                                               ; preds = %16, %0
  ...
  %21 = add i1 0, 0
  %22 = add i1 0, 0
  %23 = alloca i8, i32 %20, align 16
  %24 = icmp eq i32 %19, 0
  br i1 %24, label %27, label %25

25:               
  %26 = bitcast [15 x i8]* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 16 %23, i8* nonnull align 1 %26, i32 %19, i1 false)
  br label %27

27:                                               ; preds = %25, %18
  %28 = add i1 0, 0
  %29 = getelementptr inbounds i8, i8* %23, i32 %19
...
define dso_local i32 @main() local_unnamed_addr #1 {
  ...
  %a = alloca [5 x i8], i8 1, align 1
  store [5 x i8] [i8 37, i8 108, i8 100, i8 10, i8 0], [5 x i8]* %a, align 1
  %cast = bitcast [5 x i8]* %a to i8* 
  %ret = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(5) %cast, i64 %2)
  ret i32 0
}
