...
8:                                                ; preds = %0, %8
  %9 = phi i32 [ %12, %8 ], [ 0, %0 ]
  %10 = phi i8 [ %14, %8 ], [ %6, %0 ]
  %11 = getelementptr inbounds [10 x i8], [10 x i8]* %1, i32 0, i32 %9
...
25:               
  %26 = add i1 0, 0
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 16 %23, i8* nonnull align 1 %2, i32 %19, i1 false)
  br label %27
